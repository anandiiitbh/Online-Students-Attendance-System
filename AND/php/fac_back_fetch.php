    ...
    ?>
 <html>
<head><title> Past Attendence Record
...
function showUser(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","fac_back_rec.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
...
$sql="select DISTINCT(branch),subj.b_id from subj,branch where subj.b_id=branch.b_id and subj.fac_id = ".$login_id." group by branch ";
