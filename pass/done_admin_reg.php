...
<?php
    ...
    //mysqli_select_db($conn,'attendance_system');
		$x="insert into admin_details (name,username,password,admin_id,email_id) values('".$_SESSION['name']."','".$_SESSION['username']."','".$_SESSION['password']."','".$_SESSION['id']."','".$_SESSION['email']."')";
